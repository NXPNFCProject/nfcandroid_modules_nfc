...
public class NfcService implements DeviceHostListener, ForegroundUtils.Callback {
    ...
    final class NfcAdapterService extends INfcAdapter.Stub {
        ...
        @Override
        public boolean setControllerAlwaysOn(int mode) throws RemoteException {
    ...
    class NdefNfceeService extends INdefNfcee.Stub {
        ...
        public boolean doClearNdefData() {
            NfcPermissions.enforceUserPermissions(mContext);
            bool isEnabled =  (isNfcEnabled() || (isControllerAlwaysOn() && mAlwaysOnMode == NfcOemExtension.ENABLE_EE));
            if (!isEnabled) {
