...
public class RegisteredAidCacheTest {
    ...
    public void testIsForegroundPreferred_flagEnabled_matchesPackageName() {
        ...
        final boolean packageNameMatching =
                com.android.nfc.flags.Flags.foregroundAppPackageNameMatching();
        ExtendedMockito.when(com.android.nfc.flags.Flags.foregroundAppPackageNameMatching())
                .thenReturn(true);
        mRegisteredAidCache =
                new RegisteredAidCache(mContext, mWalletRoleObserver, mAidRoutingManager);
        ...
        ExtendedMockito.when(com.android.nfc.flags.Flags.foregroundAppPackageNameMatching())
                .thenReturn(packageNameMatching);
    }
